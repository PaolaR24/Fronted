...
id int primary key,
empresa varchar(60) not null,-- PURINA , DOG CHOW ,  OH MAI GAT, ARENA CALABAZA , etc
...
tipo_doc varchar(50) not null, -- Cedula, Pasaporte, Etc
nro_doc varchar(20) not null,
cuil varchar(30) not null, -- Si no tiene Pasaporte, DNI
...
create type tipo_pago_enum as enum('EFECTIVO','CHEQUE','TARJETA CREDITO', 'TARJETA DEBITO','DAVIPLATA','NEQUI');
...
costo_asoc decimal(8,2) not null, -- servicios, Guarderia, etc
...
tipo varchar(60) not null,-- juguetes, pelotas, medicamentos y correas, comida y camas, etc 
grupo varchar(60) not null, -- Baño, Servivio veterinario,Estirilizacion , etc
